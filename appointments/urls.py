...
from .views import SignupPatient, SignupDoctor, Login, ProfileView, DoctorList, CreateAppointment, MyAppointments, PredictHeartDisease, PredictDiabetes, ExtractID
...
urlpatterns = [
    ...
    path("ocr/extract-id/", ExtractID.as_view()),
]
